...
const FormerJudges = () => {
  ...
  const filteredJudgesList = judgesList
    .filter((judge) => judge.category === "Former")
    .filter(
      (judge) =>
      ...
      <div className='position-relative'>
        ...
        <div className='page-banner'>
          <div className='container d-flex flex-column justify-content-center' style={{ height: '200px' }}>
            <h2 className='text-white fw-bold'>Former Judges</h2>
            <nav  aria-label='breadcrumb'>
              <ol className='breadcrumb'>
                  <li className='breadcrumb-item'><Link to='/'>Home</Link></li>
                  <li className='breadcrumb-item active' aria-current='page'>Judges</li>
                  <li className='breadcrumb-item active' aria-current='page'>Former Judges</li>
              </ol>
            </nav> 
          </div> 
        </div>
      ...
      <div className="container my-5 py-5">
        ...
        {isLoading && (
          <div className="text-center py-5">
            ...
            <p className="text-muted mt-3">Fetching Former Judges...</p>
          </div>
        )}

        {isError && (
          <div className="alert alert-danger text-center py-4" role="alert">
            Failed to load Former Judges. Please try again later.
          </div>
        )}

        {!isLoading && !isError && filteredJudgesList.length === 0 && (
          <div className="text-center py-4 text-muted">
            <p>No Former Judges found.</p>
          </div>
        )}
          ...
          <>
            <div className='bg-transparent mb-3'>
              <div className="d-flex justify-content-between align-items-center px-2 mb-3 flex-wrap">
                <h4 className='fw-bold text-accent' data-aos="fade-right" data-aos-duration="1500"> <i className="bi bi-people-fill text-heading-secondary me-1"></i> Former Judges </h4> 
